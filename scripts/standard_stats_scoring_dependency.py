...
plt.title("Rui Hachimura - Scoring Dependency Model (2022–2025)")
plt.gca().invert_yaxis()
plt.tight_layout()
plt.savefig(f"{output_dir}/rui_hachimura_scoring_dependency_2022_2025.png")
plt.close()

print(f"Saved to {output_dir}/rui_hachimura_scoring_dependency_2022_2025.png")
